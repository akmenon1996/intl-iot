...
root_feature = '/Users/abhijit/Desktop/GIT_Projects/intl-iot/features/us'
root_model='/Users/abhijit/Desktop/GIT_Projects/intl-iot/models_new/with-pca/us'
...
def eval_individual_device(train_data_file, dname, specified_models = None):
    ...
    for model_alg in list_models_todo:
        ...
        ret_results.append([output_file, dname, _acc_score, _homogeneity, _complete, _vmeasure, _ari, _noise, _silhouette])
        """
        Print to Terminal 
        """
...
def test():
    ...
    if pc_name == 'JMac.local':
        # train_individual_device('/net/data/meddle/moniotr/tagged-features/cloudcam.csv', '/net/data/meddle/moniotr/tagged-models/cloudcam.model')
